...
public class PnlAddClient extends JPanel implements ActionListener, MouseInputListener{    
    ...
    public PnlAddClient(FrmStartWarehouse pater, PnlAgentManagment predecessor) {
        ...
        if (e.getSource() == btnDone) {
            ...
            if (!(textField.getText().trim().equals("") 
		 	 || textField_1.getText().trim().equals(""))) {
				...
				predecessor.getClients().add(new Client(textField.getText().trim(), textField_1.getText().trim()));
                GuardarCargarDatos.SaveObject(predecessor.getClients(), "src/data/"+ predecessor.getWarehouses().get(predecessor.getIndex()).getName() +"client.dat");
